...
namespace AmigoDono.Model
{
    ...
    public partial class Amigos_do_DonoEntities : DbContext
    {
        ...
        public virtual int spc_Controle(Nullable<int> iD, Nullable<System.DateTime> dATA)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("spc_Controle", iDParameter, dATAParameter);
        }
    }
}
